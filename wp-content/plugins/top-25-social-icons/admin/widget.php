...
<input class="icon-fields"id="<?php echo $this->get_field_id('title'); ?>" placeholder="<?php echo ucfirst( 'Title' ); ?>" name="<?php echo $this->get_field_name('title');?>" type="text" value="<?php echo $title;?>" />
</p>
...
<br/><img class="lt-images" src="<?php echo plugins_url( '/top-25-social-icons/images/icons-16/email.png')?>" alt="Email"><input class="icon-fields" id="<?php echo $this->get_field_id('text11'); ?>"  placeholder="<?php echo ucfirst( 'Email' ); ?>" name="<?php echo  $this->get_field_name('text11');?>" type="text" value="<?php echo $text11;?>" />
</p>
...
extract( $args );
 ...
 if($targetlinks =='1') $target = 'target="_blank"';
   echo $before_widget;
   // Display the widget
   ...
   if( $text4 ) {
     ...
     if( $text10 ) {
      echo '<li class="sbr_text social-icons Dribble"><a href='.$text10.'  '.$target.' data-tip="Dribble"><img width='.$imgW.'  height='.$imgh.' src='.plugins_url( '/top-25-social-icons/images/'. $imgtype .'dribble.png').'></a></li>';
   }
     if( $text11 ) {
      echo '<li class="sbr_text social-icons Email"><a href=mailto:'.$text11.' data-tip="Email"><img width='.$imgW.'  height='.$imgh.' src='.plugins_url( '/top-25-social-icons/images/'. $imgtype .'email.png').'></a></li>';
   }
     if( $text12 ) {
     ...
     if( $text15 ) {
      echo '<li class="sbr_text social-icons Tumblar"><a href='.$text15.'  '.$target.' data-tip="Tumblar"><img width='.$imgW.'  height='.$imgh.' src='.plugins_url( '/top-25-social-icons/images/'. $imgtype .'tumblr.png').'></a></li>';
   }
     if( $text16 ) {
