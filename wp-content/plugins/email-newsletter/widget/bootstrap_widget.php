...
<div class="row">
  ...
  <div class="col-md-6 eemail_button">
    <input class="eemail_textbox_button btn btn-red" name="eemail_txt_Button" id="eemail_txt_Button" onClick="return eemail_submit_ajax('<?php echo emailnews_plugin_url('widget'); ?>')" value="<?php echo get_option('eemail_widget_but_cap'); ?>" type="button">
  </div>
</div>